...
plot(aeph.ts, main="AEPh Megawatt Energy Consumption")
```
...
# ettm1
acf(diff(diff(ettm1.ts,lag=1), lag=1), lag.max=200)
...
# significant lag 1 and 2 components. Trying MA component
# seasonal ma are along the edge of unit circle
ettm1_model3 = arima(ettm1.ts, order = c(1,0,1), seasonal=list(order=c(0,1,0), period=4*4))
plot(ettm1.ts)
