...
# diff restricted to 1 -> 2 appears to flare up autocorrelations at lower lags.
ettm1_gridsearch = grid_search_cv(ettm1.ts, 0:2, 0:2, 1, periods=c(4,4*12), seasonal_ma_range=0:1,
